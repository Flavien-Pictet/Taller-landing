      ...
      <main>
        <AnimatedSection>
          <motion.h1 
            ...
            className="mt-[80px] text-center font-rethink-sans text-[40px] md:text-[50px] font-bold leading-[40px] md:leading-[50px] max-w-[415px] w-[90%] mx-auto tracking-[-2.53px] bg-gradient-to-b from-white from-10% to-[#9844FF] to-75% bg-clip-text text-transparent pb-8"
          >
            Predict & Maximize<br />
