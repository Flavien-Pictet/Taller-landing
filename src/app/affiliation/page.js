    ...
    <div className={`min-h-screen bg-[#0B0B0B] ${rethinkSans.variable} ${manrope.variable} ${interSemiBold.variable}`}>
      ...
      <main>
        <AnimatedSection>
          ...
          >
            <motion.a
              href="https://eu.jotform.com/sign/253292180557056/invite/01kazwg50hf14ba08bdedf50ea"
              target="_blank"
        ...
        <AnimatedSection>
          ...
          >
            ...
            <div 
              ...
              onClick={() => window.open('https://eu.jotform.com/sign/253292180557056/invite/01kazwg50hf14ba08bdedf50ea', '_blank')}
            >
